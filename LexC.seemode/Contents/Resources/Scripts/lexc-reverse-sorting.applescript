...
on seescriptsettings()
	...
	return {displayName:"LexC Reverse Lemma Sorting", keyboardShortcut:"^~@r", inContextMenu:"yes"}
...
-- utf8 content.
set shellscriptString to "export LANG=en_US.UTF-8; pbpaste | python '" & ScriptPathName & "' --sort=revlemma -"
