...
on seescriptsettings()
	...
	return {displayName:"LexC Sorting", keyboardShortcut:"^~@s", inContextMenu:"yes"}
...
-- utf8 content.
set shellscriptString to "export LANG=en_US.UTF-8; pbpaste | python '" & ScriptPathName & "' --sort -"
